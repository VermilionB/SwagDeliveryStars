        ...
        <Container size="xl" style={{paddingTop: '95px', display: 'flex', flexDirection: 'column', width: '100%'}}>
            <Modal opened={opened} onClose={close} title="Order details" centered miw="400px">
                <Card>
                    ...
                    <Group mt="20px">
                        {selectedOrder?.licenses.license_types.includes_mp3 && (
                            <Button size="xs">Download MP3</Button>
                        )}
                        {selectedOrder?.licenses.license_types.includes_wav && (
                            <Button size="xs">Download WAV</Button>
                        )}
                        {selectedOrder?.licenses.license_types.includes_zip && (
                            <Button size="xs">Download ZIP</Button>
                        )}
                    </Group>
                </Card>
            </Modal>
