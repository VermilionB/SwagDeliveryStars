...
//     const downloadFile = async (key: string, mime: string) => {
//         try {
//             // toggleLoadingOverlay(); // Show loading overlay
//
//             const response = await fetchAvatarFile(key);
...
//         } finally {
//             // toggleLoadingOverlay(); // Hide loading overlay when download is complete
//         }
//     };
//
//
...
//                 </Table.Tbody>
//             </Table>
//             <LoadingOverlay visible={loadingOverlayVisible} zIndex={1000} overlayProps={{ radius: 'sm', blur: 2 }} loaderProps={{ color: 'pink', type: 'bars' }} />
//
//         </Container>
//     );
// };
